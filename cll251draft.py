...
st.title("🧴☀️ Sunburn Risk & Ozone Depletion Simulator (Live Ozone Fetch)")
...
# --- Footer ---
st.markdown("---")
st.markdown("<center><small>Powered by Live Ozone Data 🌍 | Built with ❤️ using Streamlit</small></center>", unsafe_allow_html=True)
